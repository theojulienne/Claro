...
static gboolean cgraphics_treeview_selected_handler( GtkTreeSelection *selection, gpointer data )
{
...
static gboolean cgraphics_treeview_rightclick_handler( GtkWidget *widget, GdkEventButton *event, widget_t *cw )
{
...
static void cgraphics_treeview_item_to_iter( widget_t *widget, list_item_t *item, GtkTreeIter *iter )
{
	GtkTreeStore *store;
